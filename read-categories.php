            ...
            <div class="col-md-12">
              <div id="blogCarousel" class="carousel slide container-blog" data-ride="carousel">
                ...
                //ini_set('display_errors', 'on');
                    ...
                    if ( !empty($id_categorie) && $id_categorie > 0) {
                        //var_dump($id_article);
                        // Fecth news
                        $categorie = getACategorie( $id_categorie, $dbh );
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    ...
                    <?php if ( $categorie && !empty($categorie) ) :?>
                      
                      <div style="margin: auto;" class="col-md-4" >
                        <div class="item-box-blog">
                          <div class="item-box-blog-image">
                            <!--Date-->
                            <div class="item-box-blog-date bg-blue-ui white"> <span class="mon">publié le <?= dateToFrench( $categorie->dateCreation, "l j F Y, H:i") ?></span> </div>
                            <!--Image-->
                          ...
                          <div class="item-box-blog-body">
                            ...
                            <div class="item-box-blog-heading">
                              <a href="#" tabindex="0">
                                <h5><?= stripslashes($categorie->titre) ?></h5>
                              </a>
                            </div>
                            <!--Data-->
                            ...
                            <div class="item-box-blog-text">
                              <p><?= stripslashes($categorie->contenu) ?></p>
                            </div>
